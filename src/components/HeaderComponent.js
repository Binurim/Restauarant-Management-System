        ...
        <Navbar dark expand="md">
          <div className="container">
            ...
            <Collapse isOpen={this.state.isNavOpen} navbar>
              <Nav navbar>
                <NavItem>
                  <NavLink className="nav-link mr-1" to="/home">
                    <span className="fa fa-home fa-sm"></span> Home
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink className="nav-link mr-1" to="/aboutus">
                    <span className="fa fa-info fa-sm"></span> About Us
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink className="nav-link mr-1" to="/menu">
                    <span className="fa fa-list fa-sm"></span> Menu
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink className="nav-link mr-1" to="/contactus">
              ...
              <Nav className="ml-auto" navbar>
                <NavItem>
                  ...
                  <span className="fa fa-sign-in fa-sm login-button"></span> Login
                  </Button>
                </NavItem>
                </Nav>
            </Collapse>
            ...
            <div className="row row-header">
              <div className="col-12 col-sm-6">
                ...
                <p>
                  ...
                  a unique fusioon experience. Our lipsmacking creations will
